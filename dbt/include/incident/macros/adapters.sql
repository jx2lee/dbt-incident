...
{% macro incidentadapter__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro incidentadapter__check_schema_exists(information_schema,schema) -%}
...
{% macro incidentadapter__create_schema(relation) -%}
...
{% macro incidentadapter__drop_relation(relation) -%}
...
{% macro incidentadapter__drop_schema(relation) -%}
...
{% macro incidentadapter__get_columns_in_relation(relation) -%}
...
{% macro incidentadapter__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro incidentadapter__list_schemas(database) -%}
...
{% macro incidentadapter__rename_relation(from_relation, to_relation) -%}
...
{% macro incidentadapter__truncate_relation(relation) -%}
...
{% macro incidentadapter__current_timestamp() -%}
